...
export default function Breadcrumbs() {
  ...
  return (
    <nav aria-label="Breadcrumb" className="flex items-center text-sm text-gray-500 mb-2">
      <ol className="inline-flex items-center">
        ...
        {segments.map((seg, index) => {
          ...
          const isHiddenMobile = segments.length > 2 && index > 0 && index < segments.length - 1;
