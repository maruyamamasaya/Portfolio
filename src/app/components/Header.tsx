    ...
    <header className="site-header">
      ...
      <div className="site-header-inner">
        ...
        <div className="site-header-actions">
          <DarkModeToggle />
          <Link href="/works" className="site-contact-link">作品を見に行く</Link>
      ...
      {isMenuOpen && (
        <nav className="site-mobile-nav" aria-label="モバイルナビゲーション">
          ...
          <Link href={siteConfig.contact.general} onClick={() => setIsMenuOpen(false)}>コンタクト<span aria-hidden="true">↗</span></Link>
        </nav>
      )}
    </header>
  );
