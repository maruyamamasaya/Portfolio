...
export default function About() {
  return (
    <ScrollFadeIn className="max-w-5xl mx-auto px-4 sm:px-6 md:px-10 space-y-10">
      <BlogNavButtons />
      ...
      <section className="space-y-4">
        ...
        <p className="mb-4">「脱サラ」「副業」「スキルアップ」などのテーマに寄り添いながら、実践に役立つコンテンツを発信中。ゲーム攻略のような分かりやすさを意識した、読みやすいマルチメディア構成が特徴です。</p>
        <p className="mb-4">登録フォロワー数 200名以上、発信記事数150記事以上。ビジネススキル向上に役立つ記事を中心に発信しています。</p>
        <p className="mb-4">当サイトでは、技術系ブログ・デザイン思考・アート系の視点など、多様な切り口から価値ある情報をお届けします。</p>
      </section>

      <section className="space-y-4">
        <h2 className="text-xl font-bold">導入事例</h2>
        <Card className="text-sm space-y-2">
          <h3 className="text-lg font-semibold">LINE公式アカウント × ChatGPT × AWS</h3>
          <p>LINE自動応答・モバイルオーダー機能の独自開発</p>
          <ul className="list-disc pl-5 space-y-1">
            <li>AWS上で構築したインフラにLINE Messaging APIとChatGPTを統合</li>
            <li>注文・問い合わせ・予約がLINE上で完結するモバイルオーダー仕組みを提供</li>
            <li>使用技術：AWS（Lambda, API Gateway, DynamoDB, S3 他）／LINE Messaging API／OpenAI API</li>
            <li>開発内容：自動応答Bot構築、注文情報の管理、メニュー表示・選択フロー設計</li>
            <li>特徴：インフラレスでスケーラブルな構成／ノーアプリで完結するUX</li>
          </ul>
        </Card>
      </section>
      ...
      <section className="space-y-4 text-sm">
        ...
        <p className="mb-4">
          <strong>「信頼される技術者であること」</strong>を最優先に、ユーザー視点での価値提供を心がけています。
          単なる知識提供や技術支援ではなく、本当に“役に立つ”体験を届けることを軸に活動しています。
        </p>
        <div className="grid gap-4 md:grid-cols-3">
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
            <p className="font-semibold">ユーザーファースト</p>
            <p>誰にでもわかりやすく、丁寧なサポートを心がけ、相談しやすい空気感を大切にしています。</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
            <p className="font-semibold">信頼性の担保</p>
            <p>不確かな情報は扱わず、検証・確認を通じた正確なアドバイスを提供します。</p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow">
            <p className="font-semibold">継続学習の姿勢</p>
            <p>テクノロジーの進化に対応し続けるため、自ら学び、検証し、常に最新の知識で向き合います。</p>
          </div>
        </div>
      </section>
